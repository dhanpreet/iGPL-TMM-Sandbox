	...
	<div class="tab-content" id="pills-tabContent">
		<div class="tab-pane fade active in" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">		  
			...
			<div class="global-leaderboard" >				
					...
					<div class=" leader-container relative">
						<img src="<?php echo base_url() ?>assets/frontend/img/bg/2.jpg" style="width:100%; max-height:250px;">
		...
		<div class="row" style="margin-top:-100px;">
			<div class="col-md-12 text-center" >
				<a style="display: unset; padding: 12px 40px !important;" class="create-btn-text" href="<?php echo site_url('site/globalLeaderboard') ?>">View Top 50</a>
			</div>
		</div>
</section>
