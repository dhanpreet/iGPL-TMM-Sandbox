											...
											<div class="col-md-6">
												...
												<div class="col-md-12">
													<select class="form-control" name="tournament_section" id="tournament_section" required >
														<option value="">Choose option</option>
														<option value="3" <?php  if($tournamentInfo['tournament_section'] == 3){ echo "selected"; } ?>>Daily Tournament</option>
														<option value="2" <?php  if($tournamentInfo['tournament_section'] == 2){ echo "selected"; } ?>>Weekly Tournament</option>
														<option value="1" <?php  if($tournamentInfo['tournament_section'] == 1){ echo "selected"; } ?>>Hero Tournament</option>
