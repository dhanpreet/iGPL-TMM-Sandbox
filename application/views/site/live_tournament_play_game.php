		...
		<div class="padd">
			<div class="padd  col-md-12">
				...
				<div class="nav-back " style="width:98%;" align="center">
					...
					<span data-countdown="<?php echo date('Y-m-d', strtotime($tournamentInfo['tournament_end_date'])).' '.$tournamentInfo['tournament_end_time'].':00'; ?>"></span>
				</div>
...
$(document).ready(function() {
	$('[data-countdown]').each(function() { 
		var $_this = $(this);
		var finalDate = moment.tz($_this.data('countdown'), "Asia/Rangoon");
